...
TRAJECTORY_BUILDER_2D.min_range = 0.3 --Minimum distance in metres for detection
TRAJECTORY_BUILDER_2D.max_range = 3.0 --Maximum distance in metres for detection
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 3.0 --Replacement distance for missing_data_ray_length
...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.rotation_delta_cost_weight = 4.2
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 2e2
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 4.2e2
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 2 -- Decrease
